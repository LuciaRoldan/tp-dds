...
//	            categoria     $/kWh  $/mes  maximo  minimo 
	CATEGORIAR1("CATEGORIA1", 0.644, 18.76, 150.00, 0.00), 
	CATEGORIAR2("CATEGORIA2", 0.644, 35.32, 325.00, 150.00),
	CATEGORIAR3("CATEGORIA3", 0.681, 60.71, 400.00, 325.00),
	CATEGORIAR4("CATEGORIA4", 0.738, 71.74, 450.00, 400.00),
	CATEGORIAR5("CATEGORIA5", 0.794, 110.38, 500.00, 450.00),
	CATEGORIAR6("CATEGORIA6", 0.832, 220.75, 600.00, 500.00), 
	CATEGORIAR7("CATEGORIA7", 0.851, 443.59, 700.00, 600.00), 
	CATEGORIAR8("CATEGORIA8", 0.851, 545.96, 1400.00, 700.00), 
	CATEGORIAR9("CATEGORIA9", 0.851, 887.19, 10000000.00, 1400.00);
