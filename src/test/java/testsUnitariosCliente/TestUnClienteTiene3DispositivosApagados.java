...
public class TestUnClienteTiene3DispositivosApagados {
	...
	public void test() {
		...
		dispositivos.add(new Dispositivo("Dispositivo1", 1, false, new DispositivoEstandar())); 
		dispositivos.add(new Dispositivo("Dispositivo2", 1, true, new DispositivoEstandar()));
		dispositivos.add(new Dispositivo("Dispositivo3", 1, true, new DispositivoEstandar()));
		dispositivos.add(new Dispositivo("Dispositivo4", 1, false, new DispositivoEstandar()));
		dispositivos.add(new Dispositivo("Dispositivo5", 1, true, new DispositivoEstandar()));
