...
public class TestsSimplex {
			...
			DispositivoInteligente tvBase = new DispositivoInteligente("tvBase", encendido, 90, 360);
			Televisor tv = new Televisor(tvBase, TipoPantalla.LED, 40);
					
			DispositivoInteligente lamparaBase = new DispositivoInteligente("lamparaBase", encendido, 90, 360);
			...
			DispositivoInteligente pcBase = new DispositivoInteligente("pcBase", encendido, 60, 360);
			PC pc = new PC(pcBase, true);
					
			DispositivoInteligente aireBase = new DispositivoInteligente("aireBase", encendido, 90, 360);
			...
			DispositivoInteligente ventiladorBase = new DispositivoInteligente("ventiladorBase", encendido, 120, 360);
